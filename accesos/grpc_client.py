...
def verificar_y_ocupar_plaza(sector_id: str):
    try:
        with grpc.insecure_channel(GRPC_CHANNEL) as channel:
            ...
            # Consultar disponibilidad en el sector (El nombre en el .proto es ConsultarSector)
            ...
            # Ocupar plaza
            ocupar_res = stub.OcuparPlaza(sensores_pb2.SectorRequest(sector_id=sector_id))
